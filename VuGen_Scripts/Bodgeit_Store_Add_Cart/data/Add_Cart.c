Add_Cart()
{
	...
	web_custom_request("ServiceProxy_2", 
		...
		"Mode=HTML", 
		"EncType=application/json; charset=UTF-8", 
		"Body={\"Source\":\"Invoice\",\"MethodName\":\"GetInvoiceRequestListUserAccess\",\"Parameter\":\"{\\\"UserID\\\":\\\"fadc002ba4af04ec9f52cb2096096ac8f96fd450a0731\\\"}\"}", 
		LAST);
	...
	web_custom_request("ServiceProxy_3", 
		...
		"Mode=HTML", 
		"EncType=application/json; charset=UTF-8", 
		"Body={\"Source\":\"UserRoleAccess\",\"MethodName\":\"GetAccessList\",\"Parameter\":\"{\\\"UserID\\\": \\\"fadc002ba4af04ec9f52cb2096096ac8f96fd450a0731\\\", \\\"rootPath\\\": \\\"/ePQS\\\"}\"}", 
		LAST);

	web_custom_request("ServiceProxy_4", 
		"URL=http://intranet.ncsglobaltech.com:81/ePQS/Main/ServiceProxy", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=text/html", 
		...
		"Mode=HTML", 
		"EncType=application/json; charset=UTF-8", 
		"Body={\"Source\":\"Invoice\",\"MethodName\":\"GetInvoiceRequestList\",\"Parameter\":\"{\\\"UserID\\\":\\\"fadc002ba4af04ec9f52cb2096096ac8f96fd450a0731\\\"}\"}", 
		LAST);
